...
module.exports = {
    ...
    IG: process.env.IG || 'https://instagram.com/mhrarrydl/',
    INFO: process.env.INFO || 'ɪʀɪꜱ-ᴍᴅ;VᴇɴᴏxSᴇʀ;https://imgur.com/D60nScQ.jpg',
    URL: process.env.URL || 'https://whatsapp.com/channel/',
    SUDO: process.env.SUDO || '6287737214838',
    AUTO_STATUS_VIEW: process.env.AUTO_STATUS_VIEW || 'true',
    ALWAYS_ONLINE: process.env.ALWAYS_ONLINE || 'true',
    MODE: process.env.MODE || 'public',
    STICKER_DATA: process.env.STICKER_DATA || '️ᴍᴀᴅᴇ ʙʏ; mita',
